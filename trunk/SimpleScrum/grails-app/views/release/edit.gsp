                        ...
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:releaseInstance,field:'publishDate','errors')}">
                                    <g:datePicker name="publishDate" value="${releaseInstance?.publishDate}" precision="minute" ></g:datePicker>
                                </td>
                            </tr> 
...
<g:link controller="sprint" params="['release.id':releaseInstance?.id]" action="create">Add Sprint</g:link>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:releaseInstance,field:'startDate','errors')}">
                                    <g:datePicker name="startDate" value="${releaseInstance?.startDate}" precision="minute" ></g:datePicker>
                                </td>
                            </tr> 
