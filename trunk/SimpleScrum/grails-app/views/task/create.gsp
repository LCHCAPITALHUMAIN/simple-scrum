      ...
      <table>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: taskInstance, field: 'state', 'errors')}">
            <g:select optionKey="description" from="${com.simplescrum.model.TaskStatus?.values()}" value="${taskInstance?.state}" name="state"></g:select>
          </td>
        </tr>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: taskInstance, field: 'type', 'errors')}">
            <g:select optionKey="description" from="${com.simplescrum.model.TaskType?.values()}" value="${taskInstance?.type}" name="type"></g:select>
          </td>
        </tr>
