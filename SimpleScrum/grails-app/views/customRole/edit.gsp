    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form method="post" >
                ...
                <input type="hidden" name="version" value="${customRoleInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                ...
                                <td valign="top" class="value ${hasErrors(bean:customRoleInstance,field:'productBacklogItems','errors')}">
...
<g:link controller="productBacklogItem" params="['customRole.id':customRoleInstance?.id]" action="create">Add ProductBacklogItem</g:link>
                ...
                <div class="buttons">
                    ...
                    <span class="button"><g:link class="cancel" action="show" id="${customRoleInstance?.id}">Cancel</g:link></span>
                </div>
            </g:form>
        </div>
    </body>
