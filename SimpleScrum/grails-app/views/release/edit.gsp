...
<div class="body">
  ...
  <g:form method="post">
    ...
    <input type="hidden" name="version" value="${releaseInstance?.version}"/>
    <div class="dialog">
      <table>
        <tbody>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: releaseInstance, field: 'type', 'errors')}">
            <g:select optionKey="description" from="${com.simplescrum.model.ReleaseType?.values()}" value="${releaseInstance?.type}" name="type"></g:select>
          </td>
        </tr>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: releaseInstance, field: 'state', 'errors')}">
            <g:select optionKey="description" from="${com.simplescrum.model.ReleaseStatus?.values()}" value="${releaseInstance?.state}" name="state"></g:select>
          </td>
        </tr>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: releaseInstance, field: 'sprints', 'errors')}">
            ...
            <g:link controller="sprint" params="['release.id':releaseInstance?.id]" action="create">Add Sprint</g:link>
    ...
    <div class="buttons">
      ...
      <span class="button"><g:link class="cancel" action="show" id="${releaseInstance?.id}">Cancel</g:link></span>
    </div>
  </g:form>
</div>
</body>
