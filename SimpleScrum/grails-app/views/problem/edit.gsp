...
<div class="body">
  ...
  <g:form method="post">
      ...
      <table>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: problemInstance, field: 'state', 'errors')}">
            <g:select optionKey="description" from="${com.simplescrum.model.ProblemStatus?.values()}" value="${problemInstance?.state}" name="state"></g:select>
          </td>
        </tr>
    ...
    <div class="buttons">
      ...
      <span class="button"><g:link class="cancel" action="show" id="${problemInstance?.id}">Cancel</g:link></span>
    </div>
  </g:form>
</div>
</body>
