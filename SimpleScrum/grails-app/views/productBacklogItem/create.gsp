      ...
      <table>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: productBacklogItemInstance, field: 'type', 'errors')}">
            <g:select optionKey="description" from="${com.simplescrum.model.ProductBacklogItemType?.values()}" value="${productBacklogItemInstance?.type}" name="type"></g:select>
          </td>
        </tr>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: productBacklogItemInstance, field: 'estimationType', 'errors')}">
            <g:select optionKey="description" from="${com.simplescrum.model.EstimationType?.values()}" value="${productBacklogItemInstance?.estimationType}" name="estimationType"></g:select>
          </td>
        </tr>
        ...
        <tr class="prop">
          ...
          <td valign="top" class="value ${hasErrors(bean: productBacklogItemInstance, field: 'state', 'errors')}">
            <g:select optionKey="description" from="${com.simplescrum.model.ProductBacklogItemStatus?.values()}" value="${productBacklogItemInstance?.state}" name="state"></g:select>
          </td>
        </tr>
